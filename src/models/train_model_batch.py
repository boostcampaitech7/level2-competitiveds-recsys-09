...
def train_and_predict_models(
    ...
    xgb_model = train_xgboost_in_batches_full_data(X_train, y_train, params_xgb, batch_num=batch_num)
    ...
    cat_model = train_cat_in_batches_full_data(X_train, y_train, params_cat, batch_num=batch_num)
